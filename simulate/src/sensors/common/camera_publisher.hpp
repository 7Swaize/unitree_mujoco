...
private:
    ...
    iox2::PortFactoryPublishSubscribe<iox2::ServiceType::Ipc, DepthFrame_, void> depth_service_;
    iox2::PortFactoryPublishSubscribe<iox2::ServiceType::Ipc, RGBFrame_, void> rgb_service_;
    iox2::Publisher<iox2::ServiceType::Ipc, DepthFrame_, void> depth_pub_;
    iox2::Publisher<iox2::ServiceType::Ipc, RGBFrame_, void> rgb_pub_;
